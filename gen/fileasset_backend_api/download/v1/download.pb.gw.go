...
/*
Package downloadv1 is a reverse proxy.
...
func request_DownloadService_FetchUrl_0(ctx context.Context, marshaler runtime.Marshaler, client DownloadServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_DownloadService_FetchUrl_0(ctx context.Context, marshaler runtime.Marshaler, server DownloadServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FetchUrlRequest
	var metadata runtime.ServerMetadata
...
func RegisterDownloadServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DownloadServiceServer) error {
	...
	mux.Handle("POST", pattern_DownloadService_FetchUrl_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/fileasset_backend_api.download.v1.DownloadService/FetchUrl", runtime.WithHTTPPathPattern("/v1/download-url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DownloadService_FetchUrl_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_DownloadService_FetchUrl_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDownloadServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DownloadServiceClient) error {
	...
	mux.Handle("POST", pattern_DownloadService_FetchUrl_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/fileasset_backend_api.download.v1.DownloadService/FetchUrl", runtime.WithHTTPPathPattern("/v1/download-url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DownloadService_FetchUrl_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_DownloadService_FetchUrl_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "download-url"}, ""))
)

var (
	forward_DownloadService_FetchUrl_0 = runtime.ForwardResponseMessage
)
