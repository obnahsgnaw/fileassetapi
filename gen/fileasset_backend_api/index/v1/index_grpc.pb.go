...
const (
	IndexService_Version_FullMethodName = "/fileasset_backend_api.index.v1.IndexService/Version"
)
...
var IndexService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fileasset_backend_api.index.v1.IndexService",
	...
	Metadata: "fileasset_backend_api/index/v1/index.proto",
}

const (
	OptionsService_OptionList_FullMethodName = "/fileasset_backend_api.index.v1.OptionsService/OptionList"
)
...
var OptionsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fileasset_backend_api.index.v1.OptionsService",
