...
const (
	AssetService_ClearCache_FullMethodName = "/fileasset_backend_api.upload.v1.AssetService/ClearCache"
	AssetService_Paginate_FullMethodName   = "/fileasset_backend_api.upload.v1.AssetService/Paginate"
	AssetService_Delete_FullMethodName     = "/fileasset_backend_api.upload.v1.AssetService/Delete"
)
...
func (c *assetServiceClient) ClearCache(ctx context.Context, in *ClearCacheRequest, opts ...grpc.CallOption) (*ClearCacheResponse, error) {
	out := new(ClearCacheResponse)
	err := c.cc.Invoke(ctx, AssetService_ClearCache_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAssetServiceServer) ClearCache(context.Context, *ClearCacheRequest) (*ClearCacheResponse, error) {
...
func _AssetService_ClearCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClearCacheRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssetServiceServer).ClearCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AssetService_ClearCache_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssetServiceServer).ClearCache(ctx, req.(*ClearCacheRequest))
	}
...
var AssetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fileasset_backend_api.upload.v1.AssetService",
	HandlerType: (*AssetServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ClearCache",
			Handler:    _AssetService_ClearCache_Handler,
		},
		{
			MethodName: "Paginate",
	...
	Metadata: "fileasset_backend_api/upload/v1/asset.proto",
}
