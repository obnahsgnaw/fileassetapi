...
type AttrConfigServiceClient interface {
	...
	// 删除
	Delete(ctx context.Context, in *v1.AttrConfigIdRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *attrConfigServiceClient) Delete(ctx context.Context, in *v1.AttrConfigIdRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type AttrConfigServiceServer interface {
	...
	// 删除
	Delete(context.Context, *v1.AttrConfigIdRequest) (*emptypb.Empty, error)
}
...
func (UnimplementedAttrConfigServiceServer) Delete(context.Context, *v1.AttrConfigIdRequest) (*emptypb.Empty, error) {
...
func _AttrConfigService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AttrConfigServiceServer).Delete(ctx, req.(*v1.AttrConfigIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
