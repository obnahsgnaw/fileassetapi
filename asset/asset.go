...
func docBackendSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc/backend.swagger.json", size: 38863, mode: os.FileMode(420), modTime: time.Unix(1708665865, 0)}
...
func docFrontendSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc/frontend.swagger.json", size: 6844, mode: os.FileMode(420), modTime: time.Unix(1708665865, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
