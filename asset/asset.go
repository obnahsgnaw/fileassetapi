...
func docBackendSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc/backend.swagger.json", size: 39242, mode: os.FileMode(420), modTime: time.Unix(1710123092, 0)}
...
func docFrontendSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc/frontend.swagger.json", size: 6844, mode: os.FileMode(420), modTime: time.Unix(1710123092, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
